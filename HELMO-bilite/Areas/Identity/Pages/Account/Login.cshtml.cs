...
namespace HELMO_bilite.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            ///     directly from your code. This API may change or be removed in future releases.
            /// </summary>
            [Required(ErrorMessage = "Le champ adresse email est obligatoire.")]
            [EmailAddress(ErrorMessage = "L'adresse email spécifiée est invalide.")]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    ModelState.AddModelError(string.Empty, "Essai de connexion invalide.");
                    return Page();
                }
            }
